...
def raw_mnist_features(x):
    ...
    """
    # return np.array([np.hstack(m) for m in x]).T
...
result = {}
features_list = [raw_mnist_features, row_average_features, col_average_features, top_bottom_features]
for i,j in [(0,1),(2,4),(6,8),(9,0),(1,8), (7,1)]:
    result[(i,j)] = []
    ...
    for features in features_list:
        ...
        result[(i,j)].append(round(float(acc),2))
print(result)
